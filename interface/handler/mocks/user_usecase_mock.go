...
func (mr *MockUserUsecaseMockRecorder) GetByEmail(ctx, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockUserUsecase) GetUser(ctx context.Context, id uint64) (*model.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserUsecaseMockRecorder) ListUsers(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
